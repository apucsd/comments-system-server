...
userSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        //check user
        const isExistUser = yield exports.User.find({ userName: this.userName });
        if (isExistUser.length > 0) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Username already exist!');
        }
